...
% date_created: 2019-04-07 % original .tex template created: 2017-08-12
% license: MIT
% note:
...
\begin{document}
  ...
  \begin{rSection}{Experience}
    ...
    \begin{rSubsection}{\underline{Boston University Libraries }: Web Developer }{ Sept 2018 - Present }{ Michael Ward - Primo / Web Services Manager - mrward@bu.edu }
      ...
      \item Architect, design, implement, document, and maintain the infrastructural components of a new technical foundation at BU Libraries

      \item Assist in the design and implementation of a multi-site rebuild towards responsiveness and more consistent and feature-rich UX using web components.
  ...
  \begin{rSection}{Languages and Technologies}
    \begin{tabular}{ @{} >{\bfseries}l @{\hspace{6ex}} l }
      ...
      Novice & webpack, travis-ci, C
    \end{tabular}
  \end{rSection}

  % -- Signature -- %
  \begin{flushright}
    \em{generated using 'atla5/resume' on 2019-04-07}
  \end{flushright}
